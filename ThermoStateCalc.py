...
class Ui__frm_StateCalculator(object):
    def setupUi(self, _frm_StateCalculator):
        ...
        _frm_StateCalculator.resize(456, 604)
        ...
        self.gridLayout_6.addWidget(self._pb_Calculate, 4, 0, 1, 1)
        ...
        self._pb_Calculate_6 = QtWidgets.QPushButton(self._grp_SpecifiedProperties_2)
        self._pb_Calculate_6.setObjectName("_pb_Calculate_6")
        self.gridLayout_5.addWidget(self._pb_Calculate_6, 4, 0, 1, 5)
    ...
    def retranslateUi(self, _frm_StateCalculator):
        ...
        self._grp_SpecifiedProperties.setTitle(_translate("_frm_StateCalculator", "State 1 Specified Properties"))
